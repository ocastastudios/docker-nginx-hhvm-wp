...
RUN apt-get update && apt-get -y upgrade && \
    apt-get -y install php5-mysql php-apc curl unzip wget gawk git && \
    apt-get install -y libav-tools libavcodec-extra-54 libavformat-extra-54 && \
    apt-get -y install php5-curl php5-gd php5-intl php-pear php5-imagick php5-imap php5-mcrypt php5-memcache php5-ming php5-ps php5-pspell php5-recode php5-redis php5-sqlite php5-tidy php5-xmlrpc php5-xsl &&  \
